...
@FindBy(name="Share and get free ride points.  ")
    ...
    @FindBy(id = "com.disha.quickride:id/viewtransactions")
    private WebElement eleTransactionButton;
    public WebElement getEleTransactionbutton()
    {
    	return eleTransactionButton;
    }
    
    @FindBy(id = "com.disha.quickride:id/recharge_button")
    private WebElement eleRechargeButton;
    public WebElement getEleRechargeButton()
    {
    	return eleRechargeButton;
    }
    @FindBy(name ="Recharge")
    private WebElement eleRechageTab;
    public WebElement getEleRechargeTab()
    {
    	return eleRechageTab;
    }
	...
	myRewardsPo.getEleRechargeButton().click(); 
